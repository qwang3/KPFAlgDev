...
if __name__ == '__main__':
    ...
    for i, file in enumerate(flist):
        ...
        r = T.run()
        res.append(r)
        msg = '({}/{})'.format(i, len(flist)) + r.print()
        print(msg)

    # !!! Returning RV in [km/s]
    final_res = post.weighted(res)
    final_res[:, 1] *= 1000 # translate into [m/s]
    # sort by year
    ...
    a0.legend()
    plt.savefig('Average weighted RV')
